          ...
          <ScrollView
            ...
            <View
              ...
              <View style={{paddingVertical: 10, paddingHorizontal: 20, flexDirection:'row', justifyContent:'space-between'}}>
                  <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', width: 280 }} onPress={() => navigation.navigate('TalkChat', { user: 'Kolia', prenium:'yes', friendChoice:'kolia' })}>
                    <View>
                      <Image source={require('../../assets/images/kolia-ellipse.png')} style={{ borderRadius: 100, borderColor: '#9424FA', borderWidth: 2, width: 119, height: 119 }} />
                      <Image source={require('../../assets/images/Ellipse-62.png')} style={{ top:-40, left:100, width: 20, height: 20 }} />
                    </View>
