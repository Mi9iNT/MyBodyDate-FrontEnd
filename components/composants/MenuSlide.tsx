...
type MenuSlideProps = {
  ...
  settingsNavigation: string | undefined;
  imagePath: string;
  tabPath: string;
            ...
            onPress={() =>
              settingsNavigation
                ? navigation.navigate('SettingsStack', {
                    imagePath: null,
                    SettingsRoute: settingsNavigation,
                  })
                : navigation.goBack()
            }>
            <Image
          ...
          <Image
            source={
              icoPushChange
                ...
                : !icoPushChange && imagePath === 'Professionnel-Clair'
                ? require('../../assets/images/notification_icons-blanc.png')
                : !icoPushChange && imagePath === 'Professionnel'
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    //   AppsAffinitairesRoute: 'AppsAffinitairesRoute',
                    // });
                    navigation.navigate('AppsAffinitairesNavigator', {
