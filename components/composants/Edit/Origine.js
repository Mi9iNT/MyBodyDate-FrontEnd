...
export const Origine = ({visibleOrigine, closeModalOrigine}) => {
  const [modalOriginelVisible, setModalOriginelVisible] = useState(false);
  ...
  return (
    <Modal
      animationType="slide"
      transparent={true}
      visible={visibleOrigine}
      onRequestClose={closeModalOrigine}>
