...
export const Statut = ({visibleStatut, closeModalStatut}) => {
  const [modalStatutlVisible, setModalStatutlVisible] = useState(false);
  ...
  return (
    <Modal
      animationType="slide"
      transparent={true}
      visible={visibleStatut}
      onRequestClose={closeModalStatut}>
