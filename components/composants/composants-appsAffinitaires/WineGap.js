...
export const WineGap = ({navigation, background, menu}) => {
  ...
  return (
    <ImageBackground source={require('../../../assets/images/bg-winegap.png')} style={{width: '100%', height:'100%', resizeMode:'contain',}} >
      <Image source={require('../../../assets/images/winegap-card.png')} style={{position:'absolute', top: menu === true ? 50 : 100, width: 215, height: 95, alignSelf: 'center', resizeMode: 'cover',zIndex:2  }} />
      <LinearGradient
          ...
          style={{
            ...
            zIndex:1,
              ...
              <Text style={{ top: menu === true ? 200 : 320, left:30, color: '#fff', fontFamily: 'Gilory-Bold', textAlign: 'left', fontSize: 48, fontStyle: 'normal', fontWeight:700, }}>WineGap</Text>
            <Text style={[{top: menu === true ? 240 : 340, width:'80%', color: '#FFF',alignSelf:'center', fontFamily: 'Comfortaa-Bold',fontSize: 18,fontStyle: 'normal', }]}>
              À la recherche de rencontres et de liens intemporels : unissons nos cœurs sages !
            </Text>
            <Text style={[{top: menu === true ? 250 : 360, width:'80%', color: '#FFF',alignSelf:'center', fontFamily: 'Comfortaa-Bold',fontSize: 18,fontStyle: 'normal', }]}>
            ...
            <TouchableOpacity onPress={() => handleRadioChange(!radioValue)}>
              <View style={[{top: menu === true ? 300 : 380, flexDirection: 'row', width: '80%', alignItems: 'center', marginVertical: 5, alignSelf: 'center',}]}>
                <Image
                  source={
                    radioValue
          ...
          <TouchableOpacity onPress={() => { navigation.goBack(); }} style={{top: menu === true ? 300 : 380, left:'80%', width:50, height:50, borderRadius:100, backgroundColor:'red',}} >
