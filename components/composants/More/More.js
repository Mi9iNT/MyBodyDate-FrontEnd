...
const [copyMessage, setCopyMessage] = useState('');
  ...
  <Modal
    ...
    transparent={true}
    visible={showModal}
    onRequestClose={() => {setShowModal(false); setLinkModal('Default');}}>
    <TouchableOpacity style={{ position: 'absolute', backgroundColor: 'transparent', width: '100%', height: '100%' }} onPress={() => { setShowModal(false); setLinkModal('Default'); }} accessibilityLabel="Ferme la fenêtre" />
    {/* Contenu de la modal */}
    <View
      style={{
        top: 270,
      ...
      {copyMessageVisible && (
        <TouchableOpacity style={{ zIndex:1, position: 'absolute', bottom:130, right:0, alignItems: 'center', justifyContent:'center', height: 650, width: 400, backgroundColor: 'rgba(255, 255, 255, 0.75)'}} onPress={() => { setCopyMessageVisible(false); }}>
              <Text style={{ color: '#0019A7', fontFamily: 'Gilroy', fontSize: 20, fontStyle: 'normal', textAlign: 'center', marginBottom: 20, fontWeight: 700 }}>
            {copyMessage}
          </Text>
          <Text style={{ color: '#0019A7', fontFamily: 'Gilroy', fontSize: 20, fontStyle: 'normal', textAlign:'center', fontWeight: 700 }}>
            {profileId}
          </Text>
        </TouchableOpacity>
      )}
      <ScrollView
        ...
        <View
          style={{
            ...
            {bloquerOpen ? (
            <>
              <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', alignItems: 'center', width: '80%', height: 50, borderColor: '#0019A7', borderBottomWidth: 1 }} onPress={() => { setLinkModal('Bloquer'); setUserPrenom(userPrenom); }}>
                <Text style={{ color: '#0019A7', left:20, fontFamily: 'Gilroy', fontSize: 20, fontStyle: 'normal', fontWeight: 700 }}>Bloquer {userPrenom} ?</Text>
              </TouchableOpacity>
              <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center', alignItems: 'center', width: '80%', height: 70, borderColor: '#0019A7', borderBottomWidth: 1 }} onPress={() => { setbloquerOpen(false); setLinkModal('Liste bloquées'); }}>
          ...
          {signalerOpen ? (
            <>
              <TouchableOpacity style={{ flexDirection:'row', justifyContent:'space-between', alignSelf:'center', alignItems:'center', width:'80%', height:50, borderColor:'#0019A7', borderBottomWidth: 1}} onPress={() => { setSignalerOpen(false); setLinkModal('Signalemenent')}}>
                <Text style={{ color: '#0019A7', left:20, fontFamily: 'Gilroy', fontSize: 20, fontStyle: 'normal', fontWeight: 700 }}>Spam</Text>
              </TouchableOpacity>
              <TouchableOpacity style={{ flexDirection:'row', justifyContent:'space-between', alignSelf:'center', alignItems:'center', width:'80%', height:70, borderColor:'#0019A7', borderBottomWidth: 1}} onPress={() => { setSignalerOpen(false); setLinkModal('Signalemenent')}}>
                <Text style={{ color: '#0019A7', left:20, fontFamily: 'Gilroy', fontSize: 20, fontStyle: 'normal', fontWeight: 700 }}>Signaler un contenu comme illégal ?</Text>
              </TouchableOpacity>
              <TouchableOpacity style={{ flexDirection:'row', justifyContent:'space-between', alignSelf:'center', alignItems:'center', width:'80%', height:70, borderColor:'#0019A7', borderBottomWidth: 1}} onPress={() => {setSignalerOpen(false); setLinkModal('Signalemenent')}}>
                <Text style={{ color: '#0019A7', left:20, fontFamily: 'Gilroy', fontSize: 20, fontStyle: 'normal', fontWeight: 700 }}>Catfish cette personne est quelqu'un d’autre</Text>
              </TouchableOpacity>
              <TouchableOpacity style={{ flexDirection:'row', justifyContent:'space-between', alignSelf:'center', alignItems:'center', width:'80%', height:50, borderColor:'#0019A7', borderBottomWidth: 1}} onPress={() => {setSignalerOpen(false); setLinkModal('Signalemenent')}}>
                <Text style={{ color: '#0019A7', left:20, fontFamily: 'Gilroy', fontSize: 20, fontStyle: 'normal', fontWeight: 700 }}>Harcèlements</Text>
              </TouchableOpacity>
            </>
          ) : (null)}
          {/* Copier l’ID du profil */}
                  <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'flex-start', alignSelf: 'center', alignItems: 'center', width: '80%', height: 50, borderColor: '#0019A7', borderBottomWidth: 1 }} onPress={() => { copyProfileIdToClipboard(); }}>
