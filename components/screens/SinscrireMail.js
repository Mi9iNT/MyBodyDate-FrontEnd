...
export const SignInMail = ({ route, navigation }) => {
    ...
    <View style={Styles.container}>
           ...
           <View style={[Styles.ViewText, Styles.mt50]}>
            ...
            <SafeAreaView style={[Styles.ViewInput, {top: 180}]}>
                <TextInput
                    ...
                    value={userEmail}
                />
                <Text style={[Styles.textWhite8, {top:10}]}>Un lien pour connecter à votre ancien compte, va vous être envoyer par email</Text>
            </SafeAreaView>
        ...
        <View style={[Styles.ViewBtn2, {top: 250}]}>
            <TouchableOpacity
            style={Styles.btn}
            onPress={() => navigation.navigate('Confirmation email', {userConsent : consentement, routeName : routeChoice, loveCoach : loveCoach, userEmail: userEmail})}
