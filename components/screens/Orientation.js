        ...
        <ImageBackground style={Styles.bgGradient} source={require('../../assets/images/Background.png')}>
           <View style={[Styles.ViewText, {top:100}]}>
            ...
            <View style={[Styles.ViewBTNSelect, {top:200}]}>
                <TouchableOpacity style={[Styles.btn, Styles.mt20]} onPress={() => setState({ state: 'HétérosexeLle' })} accessibilityLabel="HétérosexeLle">
                    <Text style={(orientation.state === 'HétérosexeLle') ? [Styles.btnSelected, { color: '#0F0BAE' }] : Styles.btnNotSelected}>HétérosexeLle</Text>
                </TouchableOpacity>      
               <TouchableOpacity style={[Styles.btn, Styles.mt20]} onPress={() => setState({ state: 'HomosexueLle' })} accessibilityLabel="HomosexueLle">
                    <Text style={(orientation.state === 'HomosexueLle') ? [Styles.btnSelected, { color: '#0F0BAE' }] : Styles.btnNotSelected}>HomosexueLle</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[Styles.btn, Styles.mt20]} onPress={() => setState({ state: 'BisexueLle' })} accessibilityLabel="BisexueLle">
                    <Text style={(orientation.state === 'BisexueLle') ? [Styles.btnSelected, { color: '#0F0BAE' }] : Styles.btnNotSelected}>BisexueLle</Text>
                </TouchableOpacity>
            </View>
            ...
            <View style={[Styles.ViewBtn2,{top:130}]}>
                <TouchableOpacity style={Styles.btn} onPress={() => navigation.navigate('Recherche1', { userConsent: consentement, routeName: routeChoice, loveCoach: loveCoach, userEmail: userEmail, userPhone: userPhone, userCity: userCity, accesPosition: accesPosition, genre: genre, userBirth: userBirth, userSize: userSize, userLang : userLang, userSituation: userSituation, userOrientation: orientation.state })} accessibilityLabel="Continuer">
