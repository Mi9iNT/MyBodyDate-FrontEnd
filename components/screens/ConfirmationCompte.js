...
export const ConfirmationCompte = ({ route, navigation }) => {
    ...
    function testReached() {
        if (!code) {
            return (
                <>
                     <Lottie style={[{ top: 0, width:'80%', alignSelf: 'center', resizeMode: 'contain' }]} source={require('../../assets/animations/AnimRefuserCaptcha.json')} autoPlay loop />
                    <Text style={[Styles.textWhite2, { alignSelf: 'center', textAlign: 'center' }]}>Test non confirmé</Text>
                </>
            );
        } else {
            return (
                <>
                    <Lottie style={[{ top: -50, width:'80%', alignSelf: 'center', resizeMode: 'contain' }]} source={require('../../assets/animations/AnimValiderCaptcha.json')} autoPlay loop />
                    <Text style={[Styles.textWhite2, { top: -50, alignSelf: 'center', textAlign: 'center' }]}>Test confirmé</Text>
                </>
            );
        }
    }
    ...
    return (
        <View innerRef={ref => {this.scroll = ref}} style={[Styles.container2,{top:0}]}>
            <ImageBackground style={Styles.bgGradient} source={require('../../assets/images/Background.png')}>
                ...
                <View style={[Styles.ViewText2, {top:100}]}>
                    <Text style={[Styles.textWhite4, { top: 0, alignSelf:'center', width:'80%' }]}>Prouvez que vous n&apos;êtes pas un robot.</Text>
                    <Text style={[Styles.textWhite4, { top: 10, alignSelf: 'center', width: '80%' }]}>Pour cela, réalisez ce test pour pouvoir poursuivre.</Text>
                    {!code && (
                        <TouchableOpacity style={[{top:50}]} onPress={() => { captchaForm.current.show(); }}>
                            <Text style={[Styles.textBtn6, {zIndex:1, top:15}]}>Faire le test</Text>
                            <Image style={[{ top: -30, width: '80%', height: 60, resizeMode: 'contain', alignSelf:'center'}]} source={require('../../assets/boutons/Bouton-Rouge.png')} />
                        </TouchableOpacity>
                    )}
                </View>
                <View style={[{top:130}]}>
                    ...
                    <View style={[{top: -170}]}>
                        <TouchableOpacity
                            onPress={() => navigation.navigate('Ajouter photo', {
...
//     return (
//       <>
//         <Image style={[{ width: 100, alignSelf: 'center', resizeMode: 'contain' }]} source={require('../../assets/images/nonValide.png')} />
//         <Text style={[Styles.textWhite2, { alignSelf: 'center', textAlign: 'center' }]}>Test non confirmer</Text>
//       </>
//     );
//   } else {
//     return (
//       <>
//         <Image style={[{ top:-100, width: 100, alignSelf: 'center', resizeMode: 'contain' }]} source={require('../../assets/images/valideRose.png')} />
//         <Text style={[Styles.textWhite2, { top:-100, alignSelf: 'center', textAlign: 'center' }]}>Test confirmé</Text>
//       </>
...
//               <Text style={[Styles.textWhite4, { top: 0, alignSelf:'center', width:'80%' }]}>Prouvez que vous n'êtes pas un robot.</Text>
//               <Text style={[Styles.textWhite4, { top: 10, alignSelf: 'center', width: '80%' }]}>Pour cela réalisez ce test pour pouvoir poursuivre.</Text>
//               {code ? null : <TouchableOpacity style={[{top:50}]} onPress={() => { captchaForm.current.show(); }}>
//                 <Text style={[Styles.textBtn6, {zIndex:1, top:15}]}>Faire le test</Text>
//                 <Image style={[{ top: -30, width: '80%', height: 60, resizeMode: 'contain', alignSelf:'center'}]} source={require('../../assets/boutons/Bouton-Rouge.png')} />
//               </TouchableOpacity> }
