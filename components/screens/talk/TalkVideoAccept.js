...
export const TalkVideoAccept = ({ navigation, route }) => {
  ...
  return (
    <View style={{backgroundColor:'#fff', height:'100%', width:'auto'}}>
      ...
      <ImageBackground source={require('../../../assets/images/bg-video-call-2.png')}
        ...
        <View style={{ top: 20, width: '60%', height: 100, flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'flex-end', right: 10 }}>
          ...
          <TouchableOpacity style={{ height: 40, width: 40, right: 0, top: 0 }} onPress={() => navigation.navigate('TalkPhoneAccept')}>
          <Image style={{ top: 0, alignSelf: 'center', width: 40, height: 40 }} source={require('../../../assets/boutons/appel-video-vert.png')} />
        </TouchableOpacity>
        </View>
