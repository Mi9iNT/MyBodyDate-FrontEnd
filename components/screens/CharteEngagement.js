      ...
      >
        ...
        <ScrollView style={[Styles.ViewText, { top: -150, left: 30 }]}>
          <Text style={[Styles.textWhite2, { top: 20 }]}>
            Respect mutuel{"\n"}{"\n"}
            C&apos;est la base d&apos;une vraie histoire alors privilégiez les échanges respectueux dès le début.
          </Text>
          <Text style={[Styles.textWhite2]}>
            Soyez sincère{"\n"}{"\n"}
            Un profil (photo, âge, infos) qui vous reflète vraiment sera toujours plus séduisant.
          </Text>
          <Text style={[Styles.textWhite2]}>
            Restez prudent{"\n"}{"\n"}
            Échangez via les messages, les appels vidéo et audio avant de donner vos infos personnelles.
          </Text>
          <Modal
            animationType="slide"
            transparent={true}
          ...
          >
            <View style={Styles.centeredView4}>
              ...
              <Image
                style={[
                  { width: 100, height: 130, top: -80, resizeMode: 'cover', borderWidth: 2, borderColor: '#0F0BAE', borderRadius: 20 },
                ]}
                blurRadius={10}
              ...
              <Text style={[Styles.textBlueCenter3, { top: -40, width: 320 }]}>
                Nous les comparerons avec les photos de profil pour vérifier votre identité.
              </Text>
              <TouchableOpacity
              ...
              >
                ...
                <Image
                  style={[{ top: -20, width: 320, height: 60, resizeMode: 'contain', alignSelf: 'center' }]}
        ...
        <View style={[{ top: -20 }]}>
          ...
          >
            ...
            <Image
              style={[{ top: -20, width: '90%', height: 60, resizeMode: 'contain', alignSelf: 'center' }]}
