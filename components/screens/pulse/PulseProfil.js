...
export const PulseProfil = ({route, navigation}) => {
    ...
    <View style={{flex: 1}}>
      <ImageBackground
        ...
        <View style={{flexDirection:'row', top:30}}>
          <TouchableOpacity onPress={() => { setPath(true); navigation.navigate('Pulse profil'); }} style={{width: '50%', height:40, borderBottomWidth: path ? 1 : 3, borderBottomColor:'#fff'}}>
        ...
        <View style={{alignItems: 'center'}}>
          ...
          <Text
            ...
            Soyez remarqué.e des utilisateur.rice.s intéressé.e.s par votre type de profil. Votre profil s’affiche plusieurs fois dans les recherches et participera aux jeux aléatoires.
          </Text>
          <Text
            style={{
              fontSize: 24,
