      ...
      <ImageBackground
        ...
        <View style={{alignItems: 'center'}}>
          ...
          <Text
            ...
            Soyez remarqué.e des utilisateurs{'\n'}intéressé.es par votre type de profil. Découvrez nos offres !
          </Text>
          <Text
            style={{
              fontSize: 24,
        ...
        <View
          ...
          <Image
            source={require('../../../assets/images/Group448.png')}
            style={{
              width: 155,
              height: 190,
            }}
          />
          <Image
            source={require('../../../assets/images/Group449.png')}
            style={{
              width: 155,
              height: 225,
              top: 20,
        ...
        <View style={{alignItems: 'center', top: 70}}>
          <Image
            source={require('../../../assets/images/Group450.png')}
            style={{
              width: 160,
              height: 225,
            }}
