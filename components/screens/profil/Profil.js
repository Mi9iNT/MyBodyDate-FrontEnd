    ...
    <View style={Styles.container}>
      <ImageBackground
        ...
        <View style={[Styles.ViewText, {top: 100, left: 0}]}>
          ...
          <Text style={[Styles.textTitleWhite2, {left: 30}]}>
            Accès localisation (position) : {accesPosition}
          </Text>
          <Text style={[Styles.textTitleWhite2, {left: 30}]}>
            Genre : {genre}
          </Text>
          <Text style={[Styles.textTitleWhite2, {left: 30}]}>
            Date de naissance : {userBirth}
          </Text>
          <Text style={[Styles.textTitleWhite2, {left: 30}]}>
            Taille : {userSize}
          </Text>
          ...
          <Text style={[Styles.textTitleWhite2, {left: 30}]}>
            Recherche : {userRecherche1} {'\n'} et {userRecherche2}
          </Text>
          <Text style={[Styles.textTitleWhite2, {left: 30}]}>
            Affinité : {userAffinites}
          </Text>
          <Text style={[Styles.textTitleWhite2, {left: 30}]}>
            Rythme de vie : {rythmeDeVie1}
            {'\n'} et {rythmeDeVie2}
          </Text>
          <Text style={[Styles.textTitleWhite2, {left: 30}]}>
            Type de voix : {userVoice}
          </Text>
        </View>
      </ImageBackground>
    </View>
