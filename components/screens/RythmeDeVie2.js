        ...
        <ImageBackground style={Styles.bgGradient} source={require('../../assets/images/Background.png')}>
           <View style={[Styles.ViewText, {top:150}]}>
            ...
            <View style={[Styles.ViewBTNSelect2, {top:200}]}>
                <TouchableOpacity style={[Styles.btn]} onPress={() => handleButtonPress('Petit déjeuner')} accessibilityLabel="Petit déjeuner">
                    <Text style={selectedRythme2.includes('Petit déjeuner') ? Styles.btnSelected : Styles.btnNotSelected}>Petit déjeuner</Text>
                </TouchableOpacity>      
                <TouchableOpacity style={[Styles.btn, Styles.mt20]} onPress={() => handleButtonPress('Brunch')} accessibilityLabel="Brunch">
                    <Text style={selectedRythme2.includes('Brunch') ? Styles.btnSelected : Styles.btnNotSelected}>Brunch</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[Styles.btn, Styles.mt20]} onPress={() => handleButtonPress('Déjeuner')} accessibilityLabel="Déjeuner">
                    <Text style={selectedRythme2.includes('Déjeuner') ? Styles.btnSelected : Styles.btnNotSelected}>Déjeuner</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[Styles.btn, Styles.mt20]} onPress={() => handleButtonPress('Afterwork')} accessibilityLabel="Afterwork">
                    <Text style={selectedRythme2.includes('Afterwork') ? Styles.btnSelected : Styles.btnNotSelected}>Afterwork</Text>
                </TouchableOpacity> 
                <TouchableOpacity style={[Styles.btn, Styles.mt20]} onPress={() => handleButtonPress('Diner')} accessibilityLabel="Diner">
                    <Text style={selectedRythme2.includes('Diner') ? Styles.btnSelected : Styles.btnNotSelected}>Diner</Text>
                </TouchableOpacity>      
            </View>
            ...
            <View style={[Styles.ViewBtn2, {top:130}]}>
                <TouchableOpacity style={Styles.btn} onPress={() => navigation.navigate('Prenom', {
                    userConsent: consentement, routeName: routeChoice, loveCoach: loveCoach, userEmail: userEmail, userPhone: userPhone, userCity: userCity, accesPosition: accesPosition, genre: genre, userBirth: userBirth, userSize: userSize, userLang: userLang, userSituation: userSituation, userOrientation: userOrientation, userRecherche1: userRecherche1, userRecherche2: userRecherche2, userAffinites: userAffinites, rythmeDeVie1: rythmeDeVie1, rythmeDeVie2: selectedRythme2})} accessibilityLabel="Continuer">
