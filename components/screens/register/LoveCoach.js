    ...
    <View style={Styles.container}>
      <ImageBackground
        ...
        <View style={Styles.ViewText}>
          <Text style={[Styles.textWhite, {top: 50, left: 30}]}>
            LOVE COACH
          </Text>
          <Text style={[Styles.textWhite2, {top: 100, left: 30}]}>
            Nous sommes heureux de vous accompagner pour augmenter vos chances
            de Match en vous proposant des offres
          </Text>
          <Text style={[Styles.textWhite2, {left: 30}]}>
            personnalisées de célibataires : parent solo, etc ; et des
            invitations aux évènements près de chez vous et sur la ville de
            votre choix.
          </Text>
        </View>
