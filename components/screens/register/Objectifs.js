      ...
      <ImageBackground
        ...
        <View style={[Styles.ViewBTNSelect]}>
          <TouchableOpacity
            ...
            <Text
              style={
                selectedButtons.includes('Relation amoureuse')
                  ? Styles.btnSelected
          ...
          <TouchableOpacity
            ...
            <Text
              style={
                selectedButtons.includes("Cercle d'amis.es")
                  ? Styles.btnSelected
                  : Styles.btnNotSelected
              }>
              Cercle d'amis.es
          ...
          <TouchableOpacity
            ...
            <Text
              style={
                selectedButtons.includes('Développer mon réseau professionnel')
                  ? Styles.btnSelected
                  : Styles.btnNotSelected
              }>
        ...
        <View style={[Styles.ViewBtn2]}>
          <TouchableOpacity
            style={Styles.btn}
            onPress={() => navigation.navigate('Recherche1')}
