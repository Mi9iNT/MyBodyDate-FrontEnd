        ...
        <View style={[Styles.ViewText, {top: 100}]}>
          ...
          <TouchableOpacity accessibilityLabel="Importer une image">
            ...
            <Image
              ...
              source={require('../../../assets/boutons/Bouton-Noir-Image.png')}
            />
          </TouchableOpacity>
          <TouchableOpacity accessibilityLabel="Prendre une photo">
            <Text style={[Styles.textBtn6, {zIndex: 2, top: 45, left: 20}]}>
              Prendre une photo
            </Text>
            <Image
              style={[
          ...
          <TouchableOpacity accessibilityLabel="Meta - Facebook">
            ...
            <Image
              ...
              source={require('../../../assets/boutons/Bouton-Noir-Meta.png')}
            />
          </TouchableOpacity>
          <Text style={[Styles.textWhiteCenter2, {top: 0, width: '100%'}]}>
            Puis cliquer sur &quot;Photos&quot; {'\n'}et &quot;Toutes les
            photos&quot;
          </Text>
          <TouchableOpacity
          ...
          <Modal
            ...
            <View style={[Styles.centeredView3, {top: 200}]}>
              <Image
                style={[
                  Styles.btnCadenas,
                  {width: 100, height: 100, top: -60, resizeMode: 'contain'},
                ]}
                source={require('../../../assets/images/cadenas.png')}
              />
              <Text style={[Styles.textBlueCenter3, {top: -50}]}>
                À MONTRER{'\n'}SOUS RÉSERVE !
              </Text>
              ...
              <Text style={[Styles.textBlueCenter3, {top: -30}]}>
              ...
              <TouchableOpacity
                ...
                <Image
                  ...
                  source={require('../../../assets/boutons/Continuer-Bleu.png')}
                />
              </TouchableOpacity>
            </View>
          </Modal>
