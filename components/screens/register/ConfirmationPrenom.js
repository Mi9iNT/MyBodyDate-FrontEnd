        ...
        <View style={{top: -200}}>
          <Modal
            ...
            <View style={[Styles.centeredView2, {top: 350}]}>
              <Image
                style={[Styles.imgPrenomAdv, {top: -260}]}
                source={require('../../../assets/images/avertissement.png')}
              />
              <Text style={[Styles.textBlueCenter2, {top: -200}]}>
            ...
            <View style={[Styles.ViewBtnRow, {top: -50}]}>
              <TouchableOpacity
                ...
                <Text style={[Styles.textBtn9, {zIndex: 2, top: 40}]}>
                  Modifier
                </Text>
                <Image
                  style={[
                  ...
                  source={require('../../../assets/boutons/Bouton-Trans-Court.png')}
                />
              </TouchableOpacity>
              <TouchableOpacity
