...
export const PassFlash19 = ({route, navigation}) => {
  ...
  return (
      <ImageBackground
        ...
        <View style={{flexDirection:'row', top:30}}>
          ...
          <TouchableOpacity onPress={() => { setPath(true); navigation.navigate('Pass flash 21'); }} style={{width: '50%', height:40, borderBottomWidth: !path ? 1 : 3, borderBottomColor:'#fff'}}>
        ...
        <View style={{flexDirection:'column', justifyContent: 'space-between', alignItems:'center', top:20, height:220}}>
          <Text
            style={{
              fontSize: 18,
              fontFamily: 'Gilory',
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Pass flash 21')}>
            <Text
              style={{
                fontSize: 15,
                fontFamily: 'Gilory',
