            ...
            <ImageBackground style={Styles.bgGradient} source={require('../../assets/images/Background.png')}>
                ...
                <View style={[Styles.ViewText, {top:100}]}>
                    ...
                    <View style={[Styles.radioInputContainerTwo, {top:120}]}>
                        <Image
                        source={radioValue ? require('../../assets/images/radio_selected_noir.png') : require('../../assets/images/radio_unselected.png')}
                        style={{ width: 20, height: 20 }}
                        />
                        <Text style={[Styles.TextInputTwo]}>Cocher, pour obtenir votre abnnement Prenium</Text>
                    </View>
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={Styles.btn}
