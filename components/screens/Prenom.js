        ...
        <ImageBackground style={Styles.bgGradient} source={require('../../assets/images/Background.png')}>
           <View style={[Styles.ViewText, {top:100}]}>
                ...
                <Text style={[Styles.textWhite7, {top:100}]}>
                    Sur MyBodyDate votre vrai prénom est visible de tous les membres.{"\n"}{"\n"}Il est bon de faire une bonne première impression, en ne commençant pas par un mensonge ni aller trop vite.{"\n"}{"\n"}Vous pouvez donner votre identifiant à un(e) inconnu(e) et, il/elle vous retrouvera sur notre moteur de recherche car votre ID
            ...
            {/* <SafeAreaView style={[Styles.ViewInputPrenom, {top:350}]}>
                <TextInput
                    ...
                    <Text style={[Styles.textBlueCenter, {top:450}]}>ID.{formattedDate}.(id)</Text>
            {/*</SafeAreaView> */}
            ...
            <View style={[Styles.ViewBtn2,{top:450}]}>
                ...
                navigation.navigate('Confirmation prenom', {
                    userConsent: consentement, routeName: routeChoice, loveCoach: loveCoach, userEmail: userEmail, userPhone: userPhone, userCity: userCity, accesPosition: accesPosition, genre: genre, userBirth: userBirth, userSize: userSize, userLang: userLang, userSituation: userSituation, userOrientation: userOrientation, userRecherche1: userRecherche1, userRecherche2: userRecherche2, userAffinites: userAffinites, rythmeDeVie1: rythmeDeVie1, rythmeDeVie2: rythmeDeVie2});
                }}
