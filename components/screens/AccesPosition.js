  ...
  const checkMultiplePermissions = () => {
    checkMultiple([
      ...
      if (
        ...
        statuses[PERMISSIONS.ANDROID.ACCESS_BACKGROUND_LOCATION] === RESULTS.GRANTED ||
      ...
      <ImageBackground
        ...
        <View style={[Styles.ViewImg, { top: 50 }]}>
          ...
          <Text style={[Styles.textWhite3, { top: 50 }]}>
            Pour retrouver les personnes que vous croisez, nous avons besoin
        ...
        <View style={[{ top: -20 }]}>
          <TouchableOpacity
            ...
            <Image
              style={[
                { width: '100%', height: 60, alignSelf: 'center', resizeMode: 'contain' },
              ]}
        ...
        <View>
          <Modal
            ...
            <View style={[Styles.centeredView, { top: 200 }]}>
              <Image
                style={[
                  { top: -250, width: 40, alignSelf: 'center', resizeMode: 'contain' },
                ]}
